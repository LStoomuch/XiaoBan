...
<meta name="keywords" content="Stunning Responsive web template, Bootstrap Web Templates, Flat Web Templates,
		...
		<div class="header" id="home">
			<nav class="navbar navbar-default">
				<div class="container">
					...
					<a class="navbar-brand" href="index2.jsp"><h1>Stunning</h1><br /><span>Traveling</span></a>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
								<li><a href="index2.jsp"><span data-hover="Home">Home</span></a></li>
								<li><a href="about.jsp"><span data-hover="About">About</span></a></li>
								<li><a href="typography.jsp"><span data-hover="Shortcodes">Shortcodes</span></a></li>
								<li><a href="gallery.jsp"><span data-hover="Gallery">Gallery</span></a></li>
...
<div class="index-p">
	<div class="container">
		<div class="col-md-6 green-gird">
			<img src="images/index-p.jpg"  alt=""/>
		...
		<div class="col-md-6 index-ptext">
			...
			<a href="about.jsp">Read More<i class="glyphicon glyphicon-arrow-right"> </i></a>
		</div>
	</div>
</div>
<div class="clearfix"> </div>
