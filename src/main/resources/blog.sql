...
-- Records of t_post
-- ----------------------------
INSERT INTO `t_post` VALUES ('1', '1', '1', '1', '1', '炉石传说', '我是从去年12月开始专注玩奶骑的，因为好几个职业都已经500胜了，而骑士才不到100胜，不能忍。。。摸腿骑，中速骑，佛祖骑之前也玩过，实在无爱。正好开包出了个金光螺丝，就同时练习宇宙骑，死鱼骑，恩佐斯奶骑几套卡组。幸运的是，当月就上了传说，这个月随便打打也在月末赶上了传说。这篇文章想更多的谈游戏感受，不适合效率冲传说人士阅读，希望能与单纯追求游戏乐趣的人共勉。', '2011-05-07', '0');
INSERT INTO `t_post` VALUES ('2', '1', '2', '1', '1', '炉石传说', '新版本萨满任务是鱼人，鱼人萨满终于要出山了，这张牌跟鱼人的配合会非常好，鱼人卡组的手牌会用的非常快，一旦成功铺场之后灵魂回响，真的是解不解左右为难。\r\n　　估计以后常见的配合就是5费芬杰，6费领军加回响，一旦卡手也可以留着配合任务完成之后的一大波铺场，我很看好这张牌在鱼人萨中的表现。', '2011-05-07', '0');
INSERT INTO `t_post` VALUES ('3', '1', '3', '1', '1', '炉石传说', '炉石传说朝神在新版中一套只有3张紫卡的奇迹贼冲到国服天梯前100名，这一套极为平民的奇迹贼卡组是如何构筑的呢？看看下面的卡组推荐吧。', '2011-05-16', '0');
INSERT INTO `t_post` VALUES ('4', '1', '4', '1', '1', '炉石传说', '在最初的方案里，是有元素系法术存在的，类似于火球术这样的元素法术会触发其它的元素单卡特效；\r\n　　●当时还有一种关于元素的创意是“当你使用的最后一张牌是元素牌时……”，不过我们不喜欢当玩家触发这个特效后却好几个回合什么也没干，“如果你在上个回合使用过元素牌……”这样的特效会更简洁；\r\n　　●我们故意让某些元素衍生卡不是元素卡，这样玩家就不能在每个回合都轻易的触发元素特效了；\r\n　　●有一些旧卡是故意没有加上元素种族的，这些卡到底加不加我们还在讨论中；\r\n　　●进化（Adapt）这个机制最开始是给“加基森”版本设计的，最开始的方案里，加基森的某一个帮派拥有“机械”和“进化 Adapt”的联动词条，玩家们可以“升级”那些联动卡；\r\n　　●进化（Adapt）最初其实叫做进化（Evolve），但后来叫进化（Adapt）了，因为我们不想把进化（Adapt）和进化（Evolve）之间混淆了（然而国服依然搞混~）。\r\n　　关于进化请以上线版本描述为准（进化/Adapt）和进化/Evolve傻傻分不清，国服上线后会在翻译上做区别吗？）\r\n　　●新版本有很多非常“酷炫”的白卡，我们想让传说卡不再成为唯一的构筑核心；', '2011-05-16', '0');
INSERT INTO `t_post` VALUES ('5', '4', '5', '1', '1', '魔兽世界', '魔兽世界魔兽世界魔兽世界魔兽世界', '2011-06-16', '0');
INSERT INTO `t_post` VALUES ('7', '4', '6', '1', '1', '魔兽世界', '魔兽世界魔兽世界魔兽世界魔兽世界', '2011-06-16', '0');
INSERT INTO `t_post` VALUES ('8', '4', '7', '1', '1', '魔兽世界', '魔兽世界魔兽世界魔兽世界魔兽世界', '2011-06-16', '0');
INSERT INTO `t_post` VALUES ('20', '1', '20', '1', '1', '炉石传说', '测试。。。。', '2011-09-17', '0');
INSERT INTO `t_post` VALUES ('21', '1', '21', '1', '1', '炉石传说', '测试。。。。', '2011-09-17', '0');
INSERT INTO `t_post` VALUES ('22', '1', '22', '1', '1', '炉石传说', '测试。。。。', '2011-09-18', '0');
INSERT INTO `t_post` VALUES ('23', '1', '23', '1', '1', '炉石传说', '测试。。。。', '2011-09-18', '0');
INSERT INTO `t_post` VALUES ('24', '1', '1', '1', '2', '炉石传说', '测试。。。。', '2011-09-18', '0');
...
-- Records of t_topic
-- ----------------------------
INSERT INTO `t_topic` VALUES ('1', '1', '输赢看淡 超冷门奶骑也可以冲上传说', '1', '2011-05-07', '2011-09-18', '0', '1', '1', '0');
INSERT INTO `t_topic` VALUES ('2', '1', '放弃后期抓海贼 月末前十防战思路分享', '1', '2011-05-07', '2011-05-07', '0', '0', '1', '0');
INSERT INTO `t_topic` VALUES ('3', '1', 'TS炉石传说卡组传承史 黑夜中的奇迹贼', '1', '2011-05-16', '2011-05-16', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('4', '1', '设计师：海盗仇恨太高 临时添了针对牌', '1', '2011-05-16', '2011-05-16', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('5', '4', '7.2萨格拉斯之墓即将到来：告诉你一些需要做的准备', '1', '2011-05-16', '2011-05-16', '0', '1', '1', '0');
INSERT INTO `t_topic` VALUES ('6', '4', '写在7.15赛季末：国服战野骑2700分3V3竞技场心得', '1', '2011-05-16', '2011-05-16', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('7', '4', '7.2元素萨攻略分享：新特质收益超高 饰品无新意', '1', '2011-05-16', '2011-05-16', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('20', '1', '平民卡组也要上传说！欧服难民贼分享', '1', '2011-09-17', '2011-09-17', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('21', '1', '弃牌术 你离传说只有几个青玉德的距离', '1', '2011-09-17', '2011-09-17', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('22', '1', '墨泽炉石秀第三期 五费大表哥也能输？', '1', '2011-09-18', '2011-09-18', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('23', '1', '天梯趣味实战 土豪骑士大战狂野海盗战', '1', '2011-09-18', '2011-09-18', '0', '0', '0', '0');
INSERT INTO `t_topic` VALUES ('24', '8', '一个人的命运呀,当然要靠自我奋斗', '4', '2017-03-29', '2017-03-29', '1', '0', '1', '0');
INSERT INTO `t_topic` VALUES ('27', '8', '接龙，我先来一句，“苟”', '5', '2017-03-29', '2017-03-29', '1', '0', '0', '0');
